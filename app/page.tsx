        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1 space-y-6 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight text-gray-900 animate-typing">
              Welcome to Web <span className="text-blue-600">Stream Anime</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600">
              And this is my first Website using Next JS and skipping React. I know me so Stupid but I want to use this.
              And I want to be a Frontend Developer.
            </p>

            {/* Button to Home Page */}
            <Link href="/home" className="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-800 transition duration-300">
              Bonkey Stream
            </Link>
          </div>

          {/* Right Column - Illustration */}
          <div className="flex-1 relative h-72 md:h-auto">
            <Image
              src="/welcome-illustration.png" // Ganti dengan path gambar Anda
