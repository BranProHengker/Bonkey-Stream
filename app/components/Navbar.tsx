  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <Link href="/home" className="flex items-center space-x-3 group">
            <div className="relative w-10 h-10 rounded-xl overflow-hidden ring-2 ring-cyan-400/30 group-hover:ring-cyan-400 transition-all duration-300 shadow-[0_0_15px_rgba(34,211,238,0.3)]">
              <img src="/favicon.png" alt="Bonkey DB" className="w-full h-full object-cover" />
            </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div ref={searchRef} className="relative flex items-center">
              ...
              {isSearchOpen && searchQuery.length > 2 && (
                <div className="absolute top-full right-0 mt-3 w-72 bg-white dark:bg-slate-900 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden max-h-96 overflow-y-auto z-50">
                  {isSearching ? (
                    ...
                    <div className="py-2">
                      {searchResults.map((anime) => (
                        <div
                          ...
                          onClick={() => {
                            // Here you might want to open modal or navigate
                            // For now just navigate to home (or implement redirect)
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-300 ${isSearchOpen ? "max-h-16 opacity-100 mt-4" : "max-h-0 opacity-0"}`}>
           <input
              type="text"
              placeholder="Search anime..."
              value={searchQuery}
            ...
            />
            {/* Mobile Results would ideally go here or redirect */}
        </div>
